...
export default function Logo() {
  ...
  return (
    <div className={styled.logo}>
      ...
      <div className={styled.glasses}>
        <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 103.63 42.68">
          <g>
            <g>
              <rect
                className={`${styled.coloredLine} border`}
                x="30.08"
                y="11.04"
                width="2.54"
                height="15.01"
              ...
              />
              <path className={`${styled.coloredLine} border`} d="M33.69,17.68a.83.83,0,0,0,1.17,0l.62-.62a.82.82,0,0,0,0-1.17l-7.8-7.8a.83.83,0,0,0-1.17,0l-.62.62a.83.83,0,0,0,0,1.17Z" />
              <rect
              className={`${styled.coloredLine} border`}
                x="83.39"
                y="11.04"
      ...
      <div className={styled.play}>
        <button type="button" onClick={() => setColorize(chooseColorizeRandom())}>Colorize Glass</button>
        <button type="button" onClick={() => setColorize('black')}>Reset</button>
      </div>
    </div>
  );
}
